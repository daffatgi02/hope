      ...
      <div className="relative z-10 flex size-full flex-col justify-between p-5 text-white">
        ...
        {isComingSoon && (
          <div
            ...
            onMouseLeave={handleMouseLeave}
            className="border-hsla relative flex w-fit cursor-pointer items-center gap-1 overflow-hidden rounded-full border-primary-light/30 bg-primary-blue/20 px-5 py-2 text-xs uppercase text-primary-light backdrop-blur-sm"
          >
...
const Features = () => (
  <section className="bg-dark-navy pb-52">
    <div className="container mx-auto px-3 md:px-10">
      ...
      <div className="grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7">
        ...
        <BentoTilt className="bento-tilt_2">
          <div className="flex size-full flex-col justify-between bg-gradient-to-br from-primary-blue to-primary-dark p-5 shadow-lg">
            <h1 className="bento-title special-font max-w-64 text-white">
              D<b>a</b>n mas<b>i</b>h ban<b>y</b>ak lagi.
            </h1>
